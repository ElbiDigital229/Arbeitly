      ...
      <div className="hidden lg:flex lg:w-1/2 bg-hero-radial items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            Join thousands of job seekers who land interviews faster with Arbeitly.
          </p>
        </div>
      </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input id="firstName" placeholder="Max" className="mt-1.5" />
              </div>
              <div>
                <Label htmlFor="lastName">Last Name</Label>
                <Input id="lastName" placeholder="Müller" className="mt-1.5" />
              </div>
            </div>
            <div>
